...
DEFAULT_FILE_STORAGE = 'ECsite.aws.utils.MediaRootS3BotoStorage'
# <project-name> = Django プロジェクト名
STATICFILES_STORAGE = 'ECsite.aws.utils.StaticRootS3BotoStorage'
# <project-name> = Django プロジェクト名
...
AWS_STORAGE_BUCKET_NAME = 'new-ecsite'  # Amazon S3 のバケット名
